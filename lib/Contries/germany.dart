...
import 'package:themainnews/CountriesCategories/germanyCategories.dart';
...
class _GermanyState extends State<Germany> {
  ...
  getGermanyNews() async{
    GermanyClass germanyClass = GermanyClass();
    await germanyClass.getNews();
    articles = germanyClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => GermanyCategoriesNews(
