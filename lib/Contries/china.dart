...
import 'package:themainnews/CountriesCategories/chinaCategories.dart';
...
class China extends StatefulWidget {
  @override
  _ChinaState createState() => _ChinaState();
}
...
class _ChinaState extends State<China> {
  ...
  getChinaNews() async{
    ChinaClass chinaClass = ChinaClass();
    await chinaClass.getNews();
    articles = chinaClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => ChinaCategoryNews(
