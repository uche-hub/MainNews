...
import 'package:themainnews/CountriesCategories/canadaCategories.dart';
...
class _CanadaState extends State<Canada> {
  ...
  getCanadaNews() async{
    CanadaClass canadaClass = CanadaClass();
    await canadaClass.getNews();
    articles = canadaClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => CanadaCategoryNews(
