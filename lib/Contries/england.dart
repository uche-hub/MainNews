...
import 'package:themainnews/CountriesCategories/englandCategories.dart';
...
class England extends StatefulWidget {
  @override
  _EnglandState createState() => _EnglandState();
}
...
class _EnglandState extends State<England> {
  ...
  getEnglandNews() async{
    EnglandClass newsClass = EnglandClass();
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => EnglandCategoryNews(
