...
import 'package:themainnews/CountriesCategories/americaCategories.dart';
import 'package:themainnews/CountriesCategories/brazilCategories.dart';
...
class _BrazilState extends State<Brazil> {
  ...
  getBrazilNews() async{
    BrazilClass brazilClass = BrazilClass();
    await brazilClass.getNews();
    articles = brazilClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => BrazilCategoryNews(
