...
import 'package:themainnews/CountriesCategories/italyCategories.dart';
...
class _ItalyState extends State<Italy> {
  ...
  getItalyNews() async{
    ItalyClass italyClass = ItalyClass();
    await italyClass.getNews();
    articles = italyClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => ItalyCategoryNews(
