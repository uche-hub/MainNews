...
import 'package:themainnews/CountriesCategories/japanCategoriesNews.dart';
...
class _JapanState extends State<Japan> {
  ...
  getJapanNews() async{
    JapanClass japanClass = JapanClass();
    await japanClass.getNews();
    articles = japanClass.news;
    setState(() {
      _loading = false;
    });
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => JapanCategoryNews(
